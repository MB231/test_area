...
CppUnit::Test *StudentTestCase::suite () {
  ...
  // add the tests
  testSuite->addTest (new CppUnit::TestCaller("testConstructor", &StudentTestCase::testConstructor));
  testSuite->addTest (new CppUnit::TestCaller("testAssignAndRetrieveGrades", &StudentTestCase::testAssignAndRetrieveGrades));
  return testSuite;
}
